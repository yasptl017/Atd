        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="labAttendance.php">
                            <span class="nav-icon"><i class="bi bi-camera-video"></i></span>
                            <span class="nav-link-text">Lab Attendance</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="tutAttendance.php">
                            <span class="nav-icon"><i class="bi bi-book"></i></span>
                            <span class="nav-link-text">Tutorial Attendance</span>
                        </a>
                    </li>
